...
<record visibility="public" visnote="no login required" selected="no" depth="0">
<id>6</id>
<type id="10" conceptID="2-10">Person</type>
<citeAs>https://heuristplus.sydney.edu.au/h5-alpha/?recID=6&amp;db=EN_test_sefton</citeAs>
<title>McNeil, W.G. (William George)</title>
<added>2020-05-05 08:41:36</added>
<modified>2020-05-05 18:41:36</modified>
<workgroup id="1">Database Managers</workgroup>
<detail conceptID="2-1" name="Family name" id="1" basename="Name / Title">McNeil</detail>
<detail conceptID="2-18" name="Given name(s)" id="18" basename="Given names">William George</detail>
<detail conceptID="2-20" name="Gender" id="20" basename="Gender" termID="414" termConceptID="2-414" ParentTerm="Sex">Male</detail>
<detail conceptID="1125-72" name="Initials" id="938" basename="Initials">W.G.</detail>
<detail conceptID="1125-83" name="Early education" id="943" basename="Early education (place)" isRecordPointer="true">24</detail>
<detail conceptID="1125-88" name="Military service" id="952" basename="Military service" isRecordPointer="true">56</detail>
<detail conceptID="1125-102" name="Tertiary education" id="944" basename="Degrees (Sydney)" isRecordPointer="true">45</detail>
<detail conceptID="1125-103" name="Birth" id="951" basename="Birth" isRecordPointer="true">12</detail>
<detail conceptID="1125-104" name="Discovering Anzacs" id="973" basename="Mapping the Anzaca">https://discoveringanzacs.naa.gov.au/browse/records/111206</detail>
<detail conceptID="1125-108" name="Other URLs" id="228" basename="URLs">https://recordsearch.naa.gov.au/SearchNRetrieve/Interface/ViewImage.aspx?B=1957862</detail>
<detail conceptID="1125-151" name="Occupations" id="955" basename="Occupation &gt;" isRecordPointer="true">73</detail>
<detail conceptID="1125-196" name="University connections" id="937" basename="University connections" termID="6258" termConceptID="1125-5425" ParentTerm="UAdelaide">Roseworthy Agricultural College</detail>
<detail conceptID="1125-196" name="University connections" id="937" basename="University connections" termID="6257" termConceptID="1125-4710" ParentTerm="Universities">UAdelaide</detail>
<detail conceptID="1125-263" name="Survived" id="954" basename="Survived" termID="6454" termConceptID="1125-6095" ParentTerm="Survivorship">Survived</detail>
<detail conceptID="2-36" id="36" basename="Original ID">1125-54180</detail>
</record>
<record visibility="public" visnote="no login required" selected="no" depth="0">
<id>16</id>
...
describe('Record to Item', function () {
    ...
    it('Can get geo infortmation', async function () {
        ...
        const item = await rec.toItem();
        console.log(item);
        assert.equal(item["location"]["@id"], "1916-09-01", "Has a location");
