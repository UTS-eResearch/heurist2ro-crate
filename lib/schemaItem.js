...
class SchemaItem {
    ...
    async getConcept(){
        ...
        const itemXml = await xml2js.parseStringPromise(response.data);
           ...
           //console.log(itemXml.hml_structure[elementType][0][queryType][0], "HERE")
        try {
             ...
             if (description === "Please document the nature of this detail type (field)) ...") {
               description =  detail["dty_HelpText"][0];
             }
